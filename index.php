...
<head>
    ...
    <link rel="stylesheet" href="assets/css/Footer.css?h=7f00726931f09dd16f451d71f3ec299f">
    <link rel="stylesheet" href="assets/css/Header.css?h=be3f61a0ed692c2266df40b4d9fbbf79">
    <link rel="stylesheet" href="assets/css/styles.css?h=0a8d92a6cf2f6715bc58869b3638eaac">
...
<body style="width: 100%;height: auto;font-family: Inconsolata, monospace;">
        ...
        <div class="row" style="width: 100%;margin: 0;">
            <div class="col-md-12" style="width: 100%;padding: 0;">
                <main class="d-inline-flex flex-column justify-content-center align-items-center main" style="width: 100%;height: 950px;margin: auto;display: table-caption;"><audio class="d-inline-flex" id="audio-text" title="Text To Speech" controls="" style="margin-top: 5%;">
                        <source id="audio" src="https://texttovoices.herokuapp.com/api/?text=Halo.%20Saya%20andika.%20Saat%20ini%2C%20kamu%20sedang%20menggunakan%20suara%20saya.%20Ini%20adalah%20contoh%20suara%2C%20dalam%20bahasa%20Indonesia.&amp;gender=male&amp;lang_code=id" type="audio/mpeg">
                    </audio><textarea class="form-control-lg" id="text_to_voice" style="margin-top: 10%;resize: none;height: 30%;border: 0;border-style: none;border-color: transparent;outline: none;color: rgb(255,255,255);font-size: 14px;font-family: Inconsolata, monospace;width: 210px;border-radius: 10px;background: linear-gradient(145deg, #6c7486, #808a9f);box-shadow: 12px 12px 52px #505664, -12px -12px 52px #a0acc6;" placeholder="Enter your text..." autocomplete="off" spellcheck="true" wrap="soft" maxlength="1000" minlength="1"></textarea><button class="btn text-light audio-play-button" id="convert-text" type="button" style="margin-top: 7%;width: 125px;font-family: Inconsolata, monospace;font-size: 17px;margin-bottom: 10%;">Convert</button></main>
            </div>
        </div>
    </div>
    ...
    <script src="assets/js/main.js?h=d98c1d235dca6557e8aa4891d243a8de"></script>
</body>
